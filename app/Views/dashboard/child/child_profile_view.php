...
<div class="col-12 col-sm-12  pb-3 bg-white form-wrapper">
	...
	<h2> Personal Info </h3>
	<small> Basic info. your name profile photo and other detials </small>
...
<ul class="list-group">
  <a href="#" class="list-group-item list-group-item-action list-group-item-light d-flex justify-content-between"><span>Profile picture</span><span><img src="#"> </span><span><h4>></h4></span></a>
	<a href="#" class="list-group-item list-group-item-action list-group-item-light d-flex justify-content-between">Name<span>D.S S Hettiarachchi </span><span><h4>></h4></span></a>
	<a href="#" class="list-group-item list-group-item-action list-group-item-light d-flex justify-content-between flex-wrap ">Birthday<span>2010-01-05</span><span><h4>></h4></span></a>
