											...
											<div class="form-group">
												...
												<fieldset>
															<div class="some-class">
																<input type="radio" class="radio" name="gender" value="1 male"<?= set_value('gender','male');?>" id="male" />
																<label for="male">Male</label>
																<input type="radio" class="radio" name="gender" value="0 male"<?= set_value('gender','female');?>" id="female" />
		...
		<small> Enter your Address here </small>
										...
										<div class="col-12 col-sm-6">
											<div class="form-group">
													...
													<input type="text" class="form-control" name ="hometel" id="firstname" value="<?= set_value('hometel');?>"placeholder="Mobile Number">
													<small> Enter your first name here </small>
											</div>
										</div>
										<div class="col-12 col-sm-6">
											<div class="form-group">
													...
													<input type="text" class="form-control" name ="hometel" id="firstname" value="<?= set_value('hometel');?>"placeholder="Home Telephone Number">
													<small> Enter your first name here </small>
											</div>
										</div>
